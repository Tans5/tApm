...
import com.tans.tpowercalculator.internal.ComponentProfile
...
import com.tans.tpowercalculator.internal.jiffiesToHours
import com.tans.tpowercalculator.internal.millisToHours
import com.tans.tpowercalculator.internal.tPowerLog
import com.tans.tpowercalculator.model.CpuClusterPowerCost
import com.tans.tpowercalculator.model.CpuClusterSpeedPowerCost
import com.tans.tpowercalculator.model.CpuPowerCost
...
internal class CpuPowerCostMonitor(
    ...
    override val isSupport: Boolean = if (cpuStateSnapshotCapture.isInitSuccess) {
        try {
            check()
            tPowerLog.d(TAG, "Init CpuPowerCostMonitor success.")
            true
        } catch (e: Throwable) {
            tPowerLog.e(TAG, "Init CpuPowerMonitor fail.", e)
            false
        }
    } else {
        tPowerLog.e(TAG, "Init CpuPowerMonitor fail.")
        false
    }
    ...
    override fun onStart() {
        ...
        tPowerLog.d(TAG, "CpuPowerCostMonitor started.")
    }

    override fun onStop() {
        handler.removeMessages(CPU_POWER_COST_CHECK_MSG)
        tPowerLog.d(TAG, "CpuPowerCostMonitor stopped.")
    }
